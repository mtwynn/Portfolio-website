    ...
    <div>
      ...
      <AboutContent>
        ...
        <p>
          ...
          passion for computers at an early age, but did not delve into coding
          until my senior year of high school. Since then, I have found that my
          niches include web, mobile, and game development.
        </p>
        <h4>Interests</h4>
        <p>
          Some of my interests include making music, whether that be playing the
          piano, producing, DJing, or singing. In the future, I'd want to
